...
################################################################
# This is a generated script based on design: IP_Test
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: MemoryTestBlock_0, and set properties
  set MemoryTestBlock_0 [ create_bd_cell -type ip -vlnv manchester.ac.uk:user:MemoryTestBlock:1.0 MemoryTestBlock_0 ]

  # Create instance: MemoryTestBlock_1, and set properties
  set MemoryTestBlock_1 [ create_bd_cell -type ip -vlnv manchester.ac.uk:user:MemoryTestBlock:1.0 MemoryTestBlock_1 ]

  # Create instance: MemoryTestBlock_2, and set properties
  set MemoryTestBlock_2 [ create_bd_cell -type ip -vlnv manchester.ac.uk:user:MemoryTestBlock:1.0 MemoryTestBlock_2 ]

  # Create instance: MemoryTestBlock_3, and set properties
  set MemoryTestBlock_3 [ create_bd_cell -type ip -vlnv manchester.ac.uk:user:MemoryTestBlock:1.0 MemoryTestBlock_3 ]
  ...
  connect_bd_intf_net -intf_net MemoryTestBlock_0_m_ddr_axi [get_bd_intf_pins MemoryTestBlock_0/m_ddr_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net MemoryTestBlock_1_m_ddr_axi [get_bd_intf_pins MemoryTestBlock_1/m_ddr_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net MemoryTestBlock_2_m_ddr_axi [get_bd_intf_pins MemoryTestBlock_2/m_ddr_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net MemoryTestBlock_3_m_ddr_axi [get_bd_intf_pins MemoryTestBlock_3/m_ddr_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP3_FPD]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins MemoryTestBlock_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins MemoryTestBlock_1/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins MemoryTestBlock_2/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins MemoryTestBlock_3/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins MemoryTestBlock_0/rstn] [get_bd_pins MemoryTestBlock_1/rstn] [get_bd_pins MemoryTestBlock_2/rstn] [get_bd_pins MemoryTestBlock_3/rstn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins MemoryTestBlock_0/clk] [get_bd_pins MemoryTestBlock_1/clk] [get_bd_pins MemoryTestBlock_2/clk] [get_bd_pins MemoryTestBlock_3/clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces MemoryTestBlock_0/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces MemoryTestBlock_0/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces MemoryTestBlock_1/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces MemoryTestBlock_1/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces MemoryTestBlock_2/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP2_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces MemoryTestBlock_2/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP2_LPS_OCM
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces MemoryTestBlock_3/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP3_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces MemoryTestBlock_3/m_ddr_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP3_LPS_OCM
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MemoryTestBlock_0/s_axi_control/reg0] SEG_MemoryTestBlock_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MemoryTestBlock_1/s_axi_control/reg0] SEG_MemoryTestBlock_1_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MemoryTestBlock_2/s_axi_control/reg0] SEG_MemoryTestBlock_2_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0003000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MemoryTestBlock_3/s_axi_control/reg0] SEG_MemoryTestBlock_3_reg0
