...
HD_PWD='D:/Xilinx/MemoryTestBlock_example/MemoryTestBlock_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_Test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IP_Test_wrapper.tcl -notrace
