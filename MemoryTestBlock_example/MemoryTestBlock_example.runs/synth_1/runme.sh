...
HD_PWD='D:/Xilinx/MemoryTestBlock_example/MemoryTestBlock_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP_Test_wrapper.tcl
